...
module.exports = Mackerel = (function() {
  ...
  function Mackerel(apikey, option) {
    ...
    if (!this.apikey) {
      throw new Mackerel.prototype.NoApiKeyError;
    }
    ...
    d = Mackerel.request(opt).then((function(_this) {
      return function(_arg) {
        ...
        if (res.statusCode === 401) {
          throw new Mackerel.prototype.AuthenticationError(body.error);
        }
        if (res.statusCode >= 400) {
          throw new Mackerel.prototype.ApiError(body);
        }
  ...
  Mackerel.prototype.addHost = function(data, cb) {
    if (!data) {
      return deferred(new Mackerel.prototype.NoDataError("addHost"));
    }
  ...
  Mackerel.prototype.getHostInfo = function(id, cb) {
    if (!id) {
      return deferred(new Mackerel.prototype.NoIdError("getHostInfo"));
    }
  ...
  Mackerel.prototype.updateHostInfo = function(id, data, cb) {
    if (!id) {
      return deferred(new Mackerel.prototype.NoIdError("updateHostInfo"));
    }
    if (!data) {
      return deferred(new Mackerel.prototype.NoDataError("updateHostInfo"));
    }
  ...
  Mackerel.prototype.changeHostStatus = function(id, status, cb) {
    if (!id) {
      return deferred(new Mackerel.prototype.NoIdError("changeHostStatus"));
    }
    if (Mackerel.statuses.indexOf(status) === -1) {
      return deferred(new Mackerel.prototype.InvalidStatusError(status));
    }
  ...
  Mackerel.prototype.retireHost = function(id, cb) {
    if (!id) {
      return deferred(new Mackerel.prototype.NoIdError("retireHost"));
    }
  ...
  Mackerel.prototype.postMetric = function(data, cb) {
    if (!data) {
      return deferred(new Mackerel.prototype.NoDataError("postMetric"));
    }
...
Mackerel.prototype.ApiError = (function(_super) {
...
Mackerel.prototype.NoApiKeyError = (function(_super) {
...
Mackerel.prototype.AuthenticationError = (function(_super) {
...
Mackerel.prototype.NoDataError = (function(_super) {
...
Mackerel.prototype.NoIdError = (function(_super) {
...
Mackerel.prototype.InvalidStatusError = (function(_super) {
